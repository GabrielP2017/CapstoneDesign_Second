...
import { Badge, BarChart3, Calendar, ChevronDown, CreditCard, FileText, LayoutDashboard, 
  MessageSquare, Package, Settings,ShoppingBag, Users, Zap } from 'lucide-react'
					...
					dark:bg-slate-800/50'>
						...
						<div className='flex min-w-0'>
							<div className='flex-1 min-w-0'>
								...
								<p className='text-xs text-slate-500 dakr:text-slate-400 truncate'>
									프론트엔드 총관리자 및 웹 디자이너
								</p>
							</div>
						</div>
